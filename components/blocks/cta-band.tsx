...
export function CtaBand({
  ...
  return (
    <section className="relative overflow-hidden bg-noir text-cream">
      ...
      <div className="relative mx-auto grid max-w-[1440px] items-start gap-12 px-6 py-24 md:px-10 lg:grid-cols-2 lg:items-center lg:gap-24 lg:py-32">
        <div className="lg:hidden">
          <Eyebrow light>Le rituel</Eyebrow>
          <h2 className="mt-6 font-display text-[clamp(2.4rem,5.5vw,4.4rem)] font-medium leading-[1.03] tracking-[-0.015em] text-cream">
