...
export function PageHero({
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto grid max-w-[1440px] items-start gap-14 px-6 pb-20 pt-36 md:px-10 md:pt-44 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-20 lg:pb-28">
        ...
        <div className="flex flex-col items-start gap-8 lg:order-1">
          <div className="hidden lg:block">
            ...
            <h1 className="mt-6 font-display text-[clamp(2.6rem,6vw,5.2rem)] font-medium leading-[1.02] tracking-[-0.015em] text-noir">
              <WordReveal text={title} />
            </h1>
          </div>
